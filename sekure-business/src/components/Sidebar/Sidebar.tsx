...
const Sidebar: React.FC = () => {
  ...
  return (
    <nav className="w-[16%] 2xl:w-[15rem] max-h-[523px] flex-between flex-col gap-24 mr-5 2xl:mr-24 overflow-y-scroll no-scrollbar custom-scrollbar fixed left-0 top-20">
