  ...
  return (
    <div  className="parent-div form-select select py-[12px]" onClick={() => setOpen(!open)}>
      ...
      {open && (
        ...
        <div className={`animate-in fade-in-10 slide-in-from-top-10 ease-in-out flex flex-col gap-[3px] top-[60px] -left-24 w-[213px] rounded-[15px] py-[12px] z-50 absolute cursor-default before:absolute before:-top-3 before:left-40 before:w-[30px] before:h-[30px] before:-z-10 before:rotate-45 before:rounded-[9px] bg-white shadow-xl before:bg-white`}>
