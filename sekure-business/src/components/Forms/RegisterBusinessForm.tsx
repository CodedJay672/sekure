...
import { businessFieldSchema } from "../../_validation";
  ...
  return (
    <Form {...form}>
      <form
        ...
        className="flex justify-between h-[460px] flex-col"
      >
        <div className="flex flex-col gap-3">
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-[11px] leading-4 text-black">
                  Entrez le numero OTP envoyé par SMS
                </FormLabel>
                <FormControl>
                  <Input
                    placeholder="00000"
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-[11px] leading-4 text-black">
                  Entrez le numero OTP envoyé par mail
                </FormLabel>
                <FormControl>
                  <Input
                    placeholder="00000"
        ...
        <div className="py-3 flex flex-col">
          ...
          >
            ...
            <CgChevronRightO
              size={30}
              className="bg-white text-black rounded-full outline-none"
            />
          </Button>
