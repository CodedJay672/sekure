      ...
      <body className={inter.className}>
        <StoreProvider>
          <Provider>
            ...
            <main className="w-full bg-white pl-28 overflow-hidden">
              ...
              <footer className="w-[448px] h-[143px]">
                ...
                <div>
                  <p className="text-[9px] leading-[15px] font-normal text-[#B7B7B7]">
                    ...
                    England, E14 4HD and is authorised by the Financial Conduct
                    Authority under the Electronic Money Regulations 2011 (Firm
                    Reference 900562). Revolut Travel Ltd is authorised by the
                    Financial Conduct Authority to undertake insurance
                    distribution activities (FCA No: 780586). Our insurance
                    products are arranged by Revolut Travel Ltd and Revolut Ltd,
