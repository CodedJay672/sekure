                ...
                <footer className="w-[448px] h-[143px] mt-10">
                  ...
                  <div>
                    <p className="text-[9px] leading-[15px] font-normal text-[#B7B7B7]">
                      To learn about which Revolut company serves you or if you
                      have any questions, please contact us through our in-app
                      chat. Revolut Ltd is registered in England and Wales (No.
                      08804411), 7 Westferry Circus, Canary Wharf, London,
                      England, E14 4HD and is authorised by the Financial
                      Conduct Authority under the Electronic Money Regulations
                      2011 (Firm Reference 900562). Revolut Travel Ltd is
                      authorised by the Financial Conduct Authority to undertake
                      insurance distribution activities (FCA No: 780586). Our
                      insurance products are arranged by Revolut Travel Ltd and
                      Revolut Ltd, which is an appointed
                    </p>
                  </div>
                </footer>
              </div>
              <div className="relative flex-1 flex flex-col gap-6 bg-[url(/assets/images/signin-bg.png)] pl-10 py-10">
                <div className=" flex gap-4">
                  ...
                  <div className="flex flex-col w-[250px] pt-2">
                    ...
                    <p className="text-[12px] leading-[18px] text-[#808080]">
                      ...
                      d&apos;Afrique et du monde et à travers différents moyens
                      de paiement
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex flex-col w-[250px] pt-2">
                    ...
                    <p className="text-[12px] leading-[18px] text-[#808080]">
                      Envoyez des fonds sous toutes les devises et directement
                      dans des comptes d’utilisateurs
                    </p>
                  </div>
                </div>
                <hr className="border border-[#CDCDCD]" />
                <div className="flex gap-4">
                  ...
                  <div className="flex flex-col w-[250px] pt-2">
                    ...
                    <p className="text-[12px] leading-[18px] text-[#808080]">
                      Offres des cartes virtuelles en USD VISA et MASTERCARD
                      stables , économiques et faciles à prendre en main pour
                      vos utilisateurs
                    </p>
                  </div>
                </div>
