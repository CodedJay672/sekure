        ...
        <footer className="w-[448px] h-[143px]">
          ...
          <div>
            <p className="text-[9px] leading-[15px] font-normal text-[#B7B7B7]">
              ...
              questions, please contact us through our in-app chat. Revolut Ltd
              is registered in England and Wales (No. 08804411), 7 Westferry
              Circus, Canary Wharf, London, England, E14 4HD and is authorised
              by the Financial Conduct Authority under the Electronic Money
              Regulations 2011 (Firm Reference 900562). Revolut Travel Ltd is
